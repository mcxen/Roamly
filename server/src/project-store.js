...
const sanitizeMapMeta = (meta = {}) => {
  ...
  return {
    ...
    north_latitude: meta.north_latitude ?? null,
    south_latitude: meta.south_latitude ?? null,
    east_longitude: meta.east_longitude ?? null,
    west_longitude: meta.west_longitude ?? null,
    coverage_outline: Array.isArray(meta.coverage_outline) ? meta.coverage_outline : null,
