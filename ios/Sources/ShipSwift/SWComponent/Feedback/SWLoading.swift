...
@MainActor
final class SWLoadingManager: ObservableObject {
    static let shared = SWLoadingManager()

    @Published private var pageStates: [SWLoadingPage: SWPageLoadingState] = [:]
...
struct SWPageLoadingView: View {
    ...
    @ObservedObject private var manager = SWLoadingManager.shared
    @State private var pulseAnimation = false

    private var state: SWPageLoadingState {
        manager.state(for: page)
    }
