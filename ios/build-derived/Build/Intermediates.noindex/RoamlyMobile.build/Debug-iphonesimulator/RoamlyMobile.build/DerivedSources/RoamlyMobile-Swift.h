...
#ifndef ROAMLYMOBILE_SWIFT_H
#define ROAMLYMOBILE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RoamlyMobile",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
SWIFT_CLASS("_TtC12RoamlyMobile11AppDelegate")
...
@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC12RoamlyMobile20BackupViewController")
...
SWIFT_CLASS("_TtC12RoamlyMobile21LibraryViewController")
@interface LibraryViewController : UIViewController <UICollectionViewDataSource, UICollectionViewDataSourcePrefetching, UICollectionViewDelegateFlowLayout>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
...
@class UITextField;
@class UITextView;
SWIFT_CLASS("_TtC12RoamlyMobile23MapDetailViewController")
@interface MapDetailViewController : UIViewController <MKMapViewDelegate, UIGestureRecognizerDelegate, UITextFieldDelegate, UITextViewDelegate>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
...
@class UIControl;
SWIFT_CLASS("_TtC12RoamlyMobile26MapWorkbenchViewController")
@interface MapWorkbenchViewController : UIViewController <MKMapViewDelegate>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewWillDisappear:(BOOL)animated;
...
SWIFT_CLASS("_TtC12RoamlyMobile22OrganizeViewController")
@interface OrganizeViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
...
SWIFT_CLASS("_TtC12RoamlyMobile31RegionPickerSheetViewController")
@interface RegionPickerSheetViewController : UIViewController <UIPickerViewDataSource, UIPickerViewDelegate, UITextFieldDelegate>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE;
- (void)viewDidLoad;
...
@class UITab;
SWIFT_CLASS("_TtC12RoamlyMobile20RootTabBarController")
@interface RootTabBarController : UITabBarController <UINavigationControllerDelegate, UITabBarControllerDelegate>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE;
- (void)viewDidLoad;
- (void)viewDidLayoutSubviews;
...
SWIFT_CLASS("_TtC12RoamlyMobile13SceneDelegate")
...
SWIFT_CLASS("_TtC12RoamlyMobile27SelectionListViewController")
@interface SelectionListViewController : UIViewController <UISearchResultsUpdating, UITableViewDataSource, UITableViewDelegate>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC12RoamlyMobile22SettingsViewController")
